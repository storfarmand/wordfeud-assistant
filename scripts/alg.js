function 
countCombinations(letters) {

const 
maximumOccuranceOfLetters = 
makeLetterObject(letters)

var 
combinations = 
handleFirstIteration(letters)

var 
previousLoopCombinations = 
letters;
...
if(!currentWord.includes(letters[k])
|| currentWordLetterCount[letters[k]]
< maximumOccuranceOfLetters[letters[k]]) {

if(newLoopCombinations.indexOf(currentWord+letters[k])
< 0) { 
